...
def main(eps, draw):
    ...
    # some of these are actually better in Sage TM, so filter further by the
    # ones with larger magnitudes in the TM version - 36 for eps = 10.0
